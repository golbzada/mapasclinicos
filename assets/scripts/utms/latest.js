(() => {
        ...
        class r {
          ...
          static encodeAndInsert(e, t, n, l = 1) {
            ...
            const a = [
              ...
              (n &&
                (null === (i = r.adPlatformsSequencesMap[n]) || void 0 === i
                  ? void 0
                  : i.join(""))) ||
                "",
      ...
      202: (e, t, r) => {
        ...
        class i {
          ...
          static insertAdIdInWppUrl(e, t, r, n) {
            var a;
            const o =
                null !== (a = i.getQueryParams(e).get("text")) && void 0 !== a
                  ? a
                  : "Olá",
              s = t.replace(/[^0-9]/g, ""),
  ...
  (() => {
    ...
    const i = r(202),
      a = {
        ignoreAllIframes: !!document.querySelector(
          "[data-utmify-ignore-iframe]",
        ),
        ignoreScriptRetry: !!document.querySelector(
          "[data-utmify-ignore-retry]",
        ),
        fastStart: !!document.querySelector("[data-utmify-fast-start]"),
        replacePlusSignal: !!document.querySelector(
        ...
        replaceLinks:
          null ===
            (l = document.querySelector("[data-utmify-replace-links]")) ||
          void 0 === l
            ? void 0
    ...
    class c {
            ...
            (n =
              null !==
                (r =
                  null !==
                    (t =
                      null !== (e = localStorage.getItem("lead")) &&
                      void 0 !== e
                        ? e
                ...
                ? r
                : localStorage.getItem("lead-tiktok")) && void 0 !== n
            ? n
            : localStorage.getItem("lead-taboola");
        if (!i) return null;
        const a = JSON.parse(i);
        return null !== (l = null == a ? void 0 : a._id) && void 0 !== l
          ? l
          : null;
      }
      ...
      static getUtmParameters() {
        ...
        let R = S;
        const A =
          null == S ? void 0 : S.includes(`${c.GOOGLE_KEYWORD_SEPARATOR}${h}`);
        h &&
          !A &&
          (R =
            null != S
              ? `${S}${c.GOOGLE_KEYWORD_SEPARATOR}${h}`
              : `${c.GOOGLE_KEYWORD_SEPARATOR}${h}`);
        let b = f("utm_content"),
          I = f("utm_medium"),
          w = f("utm_campaign"),
          y = g(f("utm_source"));
        const P = f("gclid"),
          ...
          L = f("cid");
        (a.isCartpanda
          ? U.set("cid", L || Math.round(1e11 * Math.random()).toString())
          : L && U.set("cid", L),
          U.set("utm_source", y),
          U.set("utm_campaign", w),
          U.set("utm_medium", I),
          U.set("utm_content", b),
          U.set("utm_term", R));
        ...
        if (
          (q(k) &&
            ...
            q($) &&
            ((y = g("kwai")),
            (w = (null == w ? void 0 : w.includes(k)) ? w : k),
            (I = (null == I ? void 0 : I.includes(D)) ? I : D),
            (b = (null == b ? void 0 : b.includes($))
              ? b
              : a.preventClickIdsFallback
                ? $
                : [$, j, x].join(c.CLICK_ID_SEPARATOR)),
            U.set("utm_source", y),
            U.set("utm_campaign", w),
            U.set("utm_medium", I),
            U.set("utm_content", b)),
          ...
          const e = (e) => {
            ...
            const n =
              null !==
                (r =
                  null ===
                    (t = null == e ? void 0 : e.split(c.CLICK_ID_SEPARATOR)) ||
                  void 0 === t
                    ? void 0
                    : t[0]) && void 0 !== r
                ? r
        ...
        a.isClickBank
          ? (U.set("aff_sub1", i.UrlRebuilder.removeSpecialCharacteres(y)),
            U.set(
              "aff_sub2",
              i.UrlRebuilder.removeSpecialCharacteres(w)
                .replace(/[a-zA-Z_]/g, "")
                .replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk"),
            ),
            U.set(
              "aff_sub3",
              i.UrlRebuilder.removeSpecialCharacteres(I)
                .replace(/[a-zA-Z_]/g, "")
                .replace(/\|(?=\d{10,}$)(?!.*\|)/, "cKBk"),
            ),
            U.set(
              ...
              i.UrlRebuilder.removeSpecialCharacteres(
                null !==
                  (t =
                    null ===
                      (e =
                        null == b ? void 0 : b.split(c.CLICK_ID_SEPARATOR)) ||
                    void 0 === e
                      ? void 0
                      : e[0]) && void 0 !== t
                  ? t
            ...
            U.set("aff_sub5", i.UrlRebuilder.removeSpecialCharacteres(R)),
            U.set(
              "unique_aff_sub1",
              i.UrlRebuilder.removeSpecialCharacteres(y),
            ),
            U.set(
              "unique_aff_sub2",
              i.UrlRebuilder.removeSpecialCharacteres(w)
            ...
            U.set(
              "unique_aff_sub5",
              i.UrlRebuilder.removeSpecialCharacteres(R),
            ),
            U.set("tid", 1e15 * Math.random() + "-utmify"),
            U.set("extclid", 1e15 * Math.random() + "-utmify"))
          : a.isEverflow
            ? (U.set("sub1", i.UrlRebuilder.removeSpecialCharacteres(y)),
              U.set("sub2", i.UrlRebuilder.removeSpecialCharacteres(I)),
              U.set("sub3", i.UrlRebuilder.removeSpecialCharacteres(w)),
              U.set(
                "sub4",
                i.UrlRebuilder.removeSpecialCharacteres(
                  null !==
              ...
              U.set("sub5", i.UrlRebuilder.removeSpecialCharacteres(R)))
            : a.preventSubIds ||
              (U.set("subid", i.UrlRebuilder.removeSpecialCharacteres(y)),
              U.set("subid3", i.UrlRebuilder.removeSpecialCharacteres(I)),
              U.set(
                "subid4",
                i.UrlRebuilder.removeSpecialCharacteres(
                  null !==
              ...
              U.set("subid5", i.UrlRebuilder.removeSpecialCharacteres(w)));
        const K = f("src");
        ...
        const M = [
            ...
            (null !==
              (v =
                null ===
                  (d = null == b ? void 0 : b.split(c.CLICK_ID_SEPARATOR)) ||
                void 0 === d
                  ? void 0
                  : d.length) && void 0 !== v
              ? v
              : 0)
              ? b.split(c.CLICK_ID_SEPARATOR)[0]
              : b,
            R,
          ],
          N = M.every((e) => "" === e),
        ...
        if (a.preventXcodSck) (W && U.set("xcod", W), H && U.set("sck", H));
          ...
          const e = _(M, c.UTM_AD_OBJECT_TYPE_SEPARATOR_HOTMART),
            t = (function (e, t, r) {
              ...
              return _(
                [i(a, !0, "jLj"), i(o, !0), i(s, !0), i(u, !0), i(c, !1)],
                r,
              );
            })(
              N ? ("" !== W ? W : K) : e,
        ...
        (null != F &&
          ...
          (U.set("fbclid", F),
          a.preventClickIdsFallback ||
            ((b = (null == b ? void 0 : b.includes(c.CLICK_ID_SEPARATOR))
              ? b
              : [b, F, ""].join(c.CLICK_ID_SEPARATOR)),
            U.set("utm_content", b))),
          null != P &&
            "" !== P &&
            (U.set("gclid", P),
            a.preventClickIdsFallback ||
              ((b = (null == b ? void 0 : b.includes(c.CLICK_ID_SEPARATOR))
                ? b
                : [b, P, ""].join(c.CLICK_ID_SEPARATOR)),
              U.set("utm_content", b))),
          null != C && "" !== C && U.set("gbraid", C),
          null != E && "" !== E && U.set("wbraid", E),
          null != O &&
            "" !== O &&
            (U.set("ttclid", O),
            a.preventClickIdsFallback ||
        ...
        try {
          ...
          const r = c.getUtmParameters(),
            n = (e) => {
              ...
              const t = e.split("::")[0];
              return (
                t.includes("|") ? t.substring(t.lastIndexOf("|") + 1) : t
              ).replace(/[^A-Za-z0-9_-]/g, "");
            },
            l = [
              n(r.get("utm_source")),
              n(r.get("utm_medium")),
              n(r.get("utm_campaign")),
              n(r.get("utm_content")),
              n(r.get("utm_term")),
            ];
        ...
        document.querySelectorAll("a").forEach((t) => {
          ...
          if (!(
            ...
            ((t.href = c.addUtmParametersToUrl(t.href)),
              (t.href = c.addStripeClientReferenceIdIfNeeded(t.href)),
              a.replaceLinks &&
                (function (e, t) {
                  var r, n;
          ...
          r = () => {
            e.injectUrlUpdater((e, r) => {
              ...
              for (const [e, r] of t.entries())
                e && "subid2" !== e && r && n.searchParams.set(e, r);
              return n.toString();
            });
          };
      ...
      function r(e) {
        document.querySelectorAll("form").forEach((t) => {
          ...
          (e && d.every((e) => t.action.includes(e))) ||
            ...
            (t.action = c.addStripeClientReferenceIdIfNeeded(t.action)),
        ...
        window.paramsList.forEach((t) => {
          ...
          r &&
            ((e, t) => {
              ...
              const r = new Date(
                new Date().getTime() +
                  24 * window.itemExpInDays * 60 * 60 * 1e3,
              );
          ...
          w =
            null !==
              ...
              : null ===
                ...
                : n.schema_name,
          y =
            null !== (l = null == w ? void 0 : w.includes("Dropmeta")) &&
            void 0 !== l &&
            l,
          P =
            null !== (i = null == w ? void 0 : w.includes("Warehouse")) &&
            void 0 !== i &&
            i,
          C =
            null !== (o = null == w ? void 0 : w.includes("Classic®")) &&
            void 0 !== o &&
            o,
          E =
            null !== (s = null == w ? void 0 : w.includes("Tema Vision")) &&
            void 0 !== s &&
            s,
          O =
            null !== (u = null == w ? void 0 : w.includes("Waresabino")) &&
            void 0 !== u &&
            u,
          T =
            null !== (c = null == w ? void 0 : w.includes("Dawn")) &&
            void 0 !== c &&
            c,
          U =
            null !== (d = null == w ? void 0 : w.includes("Vortex")) &&
            void 0 !== d &&
            d,
          L =
            null !== (m = null == w ? void 0 : w.includes("Warepro")) &&
            void 0 !== m &&
            m,
          k =
            null !== (v = null == w ? void 0 : w.includes("Wareimadigital")) &&
            void 0 !== v &&
            v,
          D =
            null !== (p = null == w ? void 0 : w.includes("Mercado Livre")) &&
            void 0 !== p &&
            p,
          $ =
            null !== (f = null == w ? void 0 : w.includes("Tema Evolution®")) &&
            void 0 !== f &&
            f,
          j =
            null !==
              (_ = null == w ? void 0 : w.includes("Evolution Enterprise")) &&
            void 0 !== _ &&
            _,
          x =
            null !==
              (g = null == w ? void 0 : w.includes("Tema Sabino Vision")) &&
            void 0 !== g &&
            g,
          q =
            null !== (S = null == w ? void 0 : w.includes("Split")) &&
            void 0 !== S &&
            S,
          K =
            null !== (h = null == w ? void 0 : w.includes("WART")) &&
            void 0 !== h &&
            h,
          M =
            null !== (R = null == w ? void 0 : w.includes("Vogal")) &&
            void 0 !== R &&
            R,
          N =
            null !== (A = null == w ? void 0 : w.includes("Aurohra 2.0")) &&
            void 0 !== A &&
            A,
          W =
            null !== (b = null == w ? void 0 : w.includes("RAWART")) &&
            void 0 !== b &&
            b;
        return (
          I ||
      ...
      (e(),
        ...
        (function () {
          ...
          window.open = function (t, r, n) {
            var l;
            let i = c.addUtmParametersToUrl(
              null !== (l = null == t ? void 0 : t.toString()) && void 0 !== l
                ? l
                : "",
            );
            return (
              (i = c.addStripeClientReferenceIdIfNeeded(i)),
              e(i, r || "", n || "")
            );
          };
        })(),
        n ||
          ...
          (function () {
            ...
            new MutationObserver((n, l) => {
              ...
              n.some((e) => Array.from(e.addedNodes).some(i)) ||
                (e(!0), t(), r(!0));
